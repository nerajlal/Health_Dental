...
<head>
    ...
    <title>403 - Access Forbidden | DentalChain</title>
    ...
    <div class="min-h-screen flex items-center justify-center px-4 py-12">
        <div class="max-w-3xl w-full">
            ...
            <div class="text-center mb-12">
                ...
                <div class="mb-8">
                    <div class="w-32 h-32 bg-red-100 rounded-full flex items-center justify-center mx-auto">
                        <i class="fas fa-lock text-red-600 text-6xl"></i>
                    </div>
                </div>
                
                <!-- Error Message -->
                <h1 class="text-6xl font-bold gradient-text playfair mb-4">403</h1>
                <h2 class="text-3xl font-bold text-gray-900 mb-4 playfair">Access Forbidden</h2>
            ...
            <div class="card p-8 mb-8">
                <h3 class="text-xl font-bold text-gray-900 mb-4 playfair">Why am I seeing this?</h3>
                <p class="text-gray-600 mb-4">
                    This page or resource is restricted and you don't have the necessary permissions to view it.
                </p>
                ...
                <div class="bg-blue-50 border-l-4 border-blue-500 p-4 rounded">
                    <div class="flex items-start">
                        ...
                        <div>
                            <p class="font-semibold text-blue-900 mb-1">Possible reasons:</p>
                            <ul class="text-sm text-blue-800 space-y-1">
                                ...
                                <li>• This resource is restricted to specific users</li>
                            </ul>
                        </div>
                    </div>
                </div>
            ...
            <div class="card p-8 text-center mb-8">
                <h3 class="text-2xl font-bold text-gray-900 mb-6 playfair">What can I do?</h3>
